...
class CustomEval(COCOeval):
    '''
    Modified COCO evaluation for MTSD dataset
    '''
    def __init__(self, cocoGt=None, cocoDt=None, iouType='segm'):
        ...
        self.params = CustomParams(iouType=iouType) # parameters
    ...
    def summarize(self):
        ...
        def _summarizeDets():
            ...
            stats[7] = _summarize(0, areaRng='small', maxDets=self.params.maxDets[2])
...
class CustomParams(Params):
    '''
    Params for custom evaluation. Based on Coco evaluation, but only with 0.5 IoU threshold
    '''
